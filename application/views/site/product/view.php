      ...
      <div class="box-content-center product"><!-- The box-content-center -->
           ...
           <div class='product_view_content'>
               ...
               <p class='option'>
                ...
                <p class='option'>
                  Danh mục: 
                  <a href="<?php echo $catalog->name ?>" title="LG">
...
<div class="fb-comments" data-href="<?php echo $product->name ?>" data-num-posts="5" data-width="550" data-colorscheme="light"></div>
</center>   
</div>
...
<table width="90%" cellspacing="0" cellpadding="0" border="0" style="margin:10px auto">
  <tbody>
      <tr>
          ...
          <td>
                <textarea id="content_comment" cols="50" products="3" style='width:320px' class='input' placeholder='Nội dung phản hồi' name="content">
                </textarea>
